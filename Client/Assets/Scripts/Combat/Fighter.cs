...
namespace RPG.Combat
{
    public class Fighter : MonoBehaviour, IAction
    {
        ...
        {
            if (EntityManager.Instance.IsOtherPlayer(GetComponent<BaseStats>().objectId))
            {
                return;
            }
        ...
        void Hit()
        {
            ...
            Pb.PBAttackReq req = new Pb.PBAttackReq();
            req.objId = targetBaseStats.objectId;
            NetMsgDispatcher.GetInstance().SendMessage<Pb.PBAttackReq>("PBAttackReq", req, null);
        ...
        {
            return Vector3.Distance(transform.position, targetTransform.position) < 10;
        }
